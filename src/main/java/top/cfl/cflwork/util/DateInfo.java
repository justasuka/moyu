...
public class DateInfo {
    ...
    public DateInfo(Date cal) {
        ...
        Date baseDate = null;
        try {
            baseDate = DateUtil.parseDate(" 1900年1月31日 ");
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        ...
        DateInfo lunar = new DateInfo(DateUtil.date());
        String solarTerms = DateInfo.getSolarTerms(DateUtil.date().year(), DateUtil.date().month() + 1, DateUtil.date().dayOfMonth());
        System.out.println("北京时间：" + DateUtil.format(DateUtil.date(),"yyyy年MM月dd日")
                + "　农历" + lunar + solarTerms);
